 ...
 * @param source_ts			source traffic selector that the packet matched
 * @param destination_ts	destinationtraffic selector that the packet matched
 */
typedef void (*ipsec_acquire_cb_t)(void *data, uint32_t reqid,
	traffic_selector_t *source_ts, traffic_selector_t *destination_ts);
